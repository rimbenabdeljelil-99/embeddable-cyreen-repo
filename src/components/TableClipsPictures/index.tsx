...
export default (props: Props) => {
  ...
  const processData = (data) => {
    ...
    data.forEach(item => {
      const name = item['clips_with_stores.name'];
      const video = item['clips_with_stores.original_content_name'];
  ...
  const formatTooltipContent = (name: string, video: string, item: any) => {
    const startRaw = item?.['clips_with_stores.date_start_only'];
    const endRaw = item?.['clips_with_stores.date_end_only'];
                          ...
                          <td
                            ...
                            onMouseEnter={(e) => {
                              ...
                              const item = results?.data?.find(
                                (d) => d['clips_with_stores.name'] === name && d['clips_with_stores.original_content_name'] === video
                              );
