...
export const meta = {
    name: 'KPIChartGeneralKPIs', // an identifier - must match KPIChart.emb.ts
    label: 'KPI Chart General KPIs', // user-facing name in the builder 
    ...
    inputs: [
        ...
        },
        {
            name: 'MasterRetail',
            label: 'Master Retail',
            type: 'boolean', // shows a dropdown of available datasets. These are created directly in the Builder.
        },
        {
            name: 'metrics',
